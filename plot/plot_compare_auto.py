...
fileNames = ['2021-07-12','yellow_tomorrow','yellow_15_days']
fileNames = ['2021-07-19','yellow_orange_red_auto_300']
colors = ['g','b','k','m','r'] 
...
labels = ['Scenario 1','Scenario 4']#,'Scenario 3','Scenario 4','Scenario 5']
...
for i in range(1,11):
    ...
    fig.tight_layout()
    plt.savefig(out_path+'/SUIHTER-' + region + '_' + str(Ndata - pd.Timedelta(1,'day') ).split()[0] + '_' + comps[i-1] + '_300_auto.png')
plt.show()
