...
def SUIHTERmodel_variant(t,y,params,Pop,DO,map_to_prov,dV1vec,dV2vec,R_d,variant_perc,variant_factor,kappa1,kappa2):
    ...
    #if 212<=t<217:
    #    StoUb *= (0.0016/0.0012  - 1) * (t-212)/4 + 1 
    #    StoUv *= (0.0016/0.0012  - 1) * (t-212)/4 + 1
    #    V1toUb *= (0.0022/0.0019 - 1) * (t-212)/4 + 1
    #    V1toUv *= (0.0022/0.0019 - 1) * (t-212)/4 + 1
    #    V2toUb *= (0.0022/0.0019 - 1) * (t-212)/4 + 1
    #    V2toUv *= (0.0022/0.0019 - 1) * (t-212)/4 + 1
    #elif 217<=t:
    #    StoUb *= 0.0016/0.0012 
    #    StoUv *= 0.0016/0.0012 
    #    V1toUb *= 0.0022/0.0019
    #    V1toUv *= 0.0022/0.0019
    #    V2toUb *= 0.0022/0.0019
    #    V2toUv *= 0.0022/0.0019
        
        
   # if 204<=t<209:
   #     StoUb *= (0.3862/0.2985  - 1) * (t-204)/4 + 1 
   #     StoUv *= (0.3862/0.2985  - 1) * (t-204)/4 + 1
   #     V1toUb *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
   #     V1toUv *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
   #     V2toUb *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
   #     V2toUv *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
   # elif 209<=t:
   #     StoUb *= 0.3862/0.2985 
   #     StoUv *= 0.3862/0.2985 
   #     V1toUb *= 0.5265/0.3909
   #     V1toUv *= 0.5265/0.3909
   #     V2toUb *= 0.5265/0.3909
   #     V2toUv *= 0.5265/0.3909
    
    #if 204<=t<209:
    #    StoUb *= (0.4059/0.2985  - 1) * (t-204)/4 + 1 
    #    StoUv *= (0.4059/0.2985  - 1) * (t-204)/4 + 1
    #    V1toUb *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    #    V1toUv *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUb *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUv *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    ...
    #if 204<=t<209:
    #    StoUb *= (0.4342/0.2985  - 1) * (t-204)/4 + 1 
    #    StoUv *= (0.4342/0.2985  - 1) * (t-204)/4 + 1
    #    V1toUb *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    #    V1toUv *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUb *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUv *= (0.5265/0.3909 - 1) * (t-204)/4 + 1
    ...
    #if 204<=t<209:
    #    StoUb *= (0.3570/0.2985  - 1) * (t-204)/4 + 1 
    #    StoUv *= (0.3570/0.2985  - 1) * (t-204)/4 + 1
    #    V1toUb *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V1toUv *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUb *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUv *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #elif 209<=t:
    #    StoUb *= 0.3570/0.2985 
    #    StoUv *= 0.3570/0.2985 
    #    V1toUb *= 0.4813/0.3909
    #    V1toUv *= 0.4813/0.3909
    #    V2toUb *= 0.4813/0.3909
    #    V2toUv *= 0.4813/0.3909
        
    #if 204<=t<209:
    #    StoUb *= (0.3701/0.2985  - 1) * (t-204)/4 + 1 
    #    StoUv *= (0.3701/0.2985  - 1) * (t-204)/4 + 1
    #    V1toUb *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V1toUv *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUb *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUv *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    ...
    #if 204<=t<209:
    #    StoUb *= (0.389/0.2985  - 1) * (t-204)/4 + 1 
    #    StoUv *= (0.389/0.2985  - 1) * (t-204)/4 + 1
    #    V1toUb *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V1toUv *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUb *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    #    V2toUv *= (0.4813/0.3909 - 1) * (t-204)/4 + 1
    ...
    #print(casesS,casesV1,casesV2,omega_I * (casesS + h1 * casesV1 + h2 * casesV2)/(casesSini + h1 * casesV1ini + h2 * casesV2ini))
    #print(S,V1,V2)
