...
def SUIHTERmodel_variant(t,y,params,Pop,DO,map_to_prov,dV1vec,dV2vec,R_d,variant_perc,variant_factor,kappa1,kappa2):
    ...
    #if 212<=t<217:
    #    StoUb *= (0.3701/0.2985  - 1) * (t-209)/4 + 1 
    #    StoUv *= (0.3701/0.2985  - 1) * (t-209)/4 + 1
    #    V1toUb *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #    V1toUv *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #    V2toUb *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #    V2toUv *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #elif 217<=t:
    #    StoUb *= 0.3701/0.2985 
    #    StoUv *= 0.3701/0.2985 
    ...
    #if 212<=t<217:
    #    StoUb *= (0.389/0.2985  - 1) * (t-209)/4 + 1 
    #    StoUv *= (0.389/0.2985  - 1) * (t-209)/4 + 1
    #    V1toUb *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #    V1toUv *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #    V2toUb *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
    #    V2toUv *= (0.4813/0.3909 - 1) * (t-209)/4 + 1
