...
def epiMOX(testPath,params=None,ndays=None,tf=None,estim_req=None,ext_deg_in=None,scenari=None):
    ...
    ric = pd.read_csv('https://raw.githubusercontent.com/floatingpurr/covid-19_sorveglianza_integrata_italia/main/data/2021-09-13/ricoveri.csv')
    ric = ric.iloc[:-1]
    ...
    #scenari = np.array([[209, 0.4422/0.3158]])
