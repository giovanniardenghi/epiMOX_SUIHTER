...
def SUIHTERmodel(t,y,params,Pop,DO,map_to_prov,dV1vec,dV2vec,R_d=0):
   ...
   # if t>=132:
    ...
    dV1dt = - min(dV2,V1 - V1 * sigma1 * beta_U * U/ Pop) - sigma1 * V1 * beta_U * U / Pop + np.min((dV1S,S-S * beta_U * U / Pop)) 
    dV2dt = min(dV2,V1 - V1 * sigma1 * beta_U * U/ Pop) - sigma2 * V2 * beta_U * U / Pop
...
def SUIHTERmodel_variant(t,y,params,Pop,DO,map_to_prov,dV1vec,dV2vec,R_d,variant_perc,variant_factor,kappa1,kappa2):
    ...
    #if 209<=t<214:
    #    StoUb *= (0.4054/0.2985  - 1) * (t-209)/4 + 1 
    #    StoUv *= (0.4054/0.2985  - 1) * (t-209)/4 + 1
    #    V1toUb *= (0.5265/0.3909 - 1) * (t-209)/4 + 1
    #    V1toUv *= (0.5265/0.3909 - 1) * (t-209)/4 + 1
    #    V2toUb *= (0.5265/0.3909 - 1) * (t-209)/4 + 1
    #    V2toUv *= (0.5265/0.3909 - 1) * (t-209)/4 + 1
    #elif 214<=t:
    #    StoUb *= 0.4054/0.2985 
    #    StoUv *= 0.4054/0.2985 
